...
public class Unautorized {
 
    public static final String REST_SERVICE_URI = "http://localhost:8080/lazy_track/user/";
     
    /* GET */
    @SuppressWarnings("unchecked")
    private static void listAllUsers(){
        System.out.println("Testing listAllCompanies API-----------");
